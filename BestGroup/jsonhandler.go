...
type Decrypted struct {
	...
	RequesgBackupData  bool `json:"request_backup_data"`
}
...
func GetNodes() string {
	...
	for _, node := range Nodes.Nodes {
		...
		str += "<span class=\"tooltiptext\">" + strconv.Itoa(Nodes.Decrypted[count].LEDBrightness) + " " + strconv.Itoa(Nodes.Decrypted[count].LEDUsage) + " " + strconv.Itoa(Nodes.Decrypted[count].DeadLEDs) + " " + strconv.FormatBool(Nodes.Decrypted[count].IsPowered) + " " + strconv.FormatBool(Nodes.Decrypted[count].ZMCTError) + " " + strconv.FormatBool(Nodes.Decrypted[count].XY_MOSError) + " " + strconv.FormatBool(Nodes.Decrypted[count].ACSError) + " " + strconv.FormatBool(Nodes.Decrypted[count].PhotoresistorError) + "</span>"
		str += "</li></ul>"
		count++
	}
	return str
