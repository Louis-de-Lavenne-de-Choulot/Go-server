...
func PostService(w http.ResponseWriter, r *http.Request) {
	...
	case http.MethodPost:
		...
		if !found {
			...
			//write to file
			ioutil.WriteFile("/home/groupb/Documents/BestGroup/nodes/"+name+".json", []byte("{}"), 0644)
			//save NodesFiles to end-nodes.json
			SaveJSON("/home/groupb/Documents/BestGroup/end-nodes.json", AutoGenerated{}, Users{}, NodesFiles)
		...
		err = SaveJSON("/home/groupb/Documents/BestGroup/nodes/"+name+".json", Nodes[id], Users{}, NodesI{})
		if err != nil {
