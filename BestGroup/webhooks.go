...
func PostService(w http.ResponseWriter, r *http.Request) {
	...
	case http.MethodPost:
		...
		if !found {
			loganswer("Node not found, creating new node")
			//create new filehash
			...
			//write to file
			ioutil.WriteFile(pwd+"/nodes/"+name+".json", []byte("{}"), 0644)
			//save NodesFiles to end-nodes.json
			SaveJSON(pwd+"/end-nodes.json", AutoGenerated{}, Users{}, NodesFiles)
			...
			loganswer("Node created")
		}
		loganswer("Node found two, adding data")
		...
		loganswer("Node found, adding data")
		...
		err = SaveJSON(pwd+"/nodes/"+name+".json", Nodes[id], Users{}, NodesI{})
		if err != nil {
